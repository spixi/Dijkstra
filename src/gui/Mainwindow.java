...
public class Mainwindow extends JFrame implements ActionListener, View {
	...
	public void draw() {
		...
		try {
			...
			JOptionPane.showMessageDialog(this, "Die Datei konnte nicht ge�ffnet werden", "Fehler", JOptionPane.ERROR_MESSAGE);
		}
		...
		JMenuItem textLabelFileInfo = new JMenuItem("Momentan ge�ffnete Datei:");
