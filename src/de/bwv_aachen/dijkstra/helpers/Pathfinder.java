 ...
 * DateHelper
 * <p>
 * This class contains the actual Dijkstra algorithm and selects the shortest
...
public class Pathfinder {
    ...
    public Pathfinder(Airport startAirport, Collection<Airport> airports) {
        ...
        connections = new PriorityQueue<Airport>(100,
                new MapValueComparator<Airport, Duration>(durations,
                        new GenericComparator<Duration>()));
     ...
     * updateDuration
     * <p>
     * Updates the shortest duration to a node relative to the start node. For
     * internal use only!
     * 
     * @param from
     *            : a Node
     ...
     * <p>
     * Determines the shortest path from the start node to another node. If
     * there is no possible way the behavior is undefined.
     * 
